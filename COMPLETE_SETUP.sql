-- ============================================================
-- MyCSIT — Complete Supabase Setup (Execute All at Once)
...
-- Coding activities policies (same pattern)
...
-- ============================================================
-- SAMPLE DATA (TEMPORARY - WILL BE REPLACED BY REAL AUTH USERS)
-- ============================================================

-- Note: This data requires actual auth.user IDs to work
-- You'll need to create users in Supabase Auth first, then update these UUIDs

-- Create a temporary placeholder for testing (will fail without real auth users)
...
VALUES 
  ('YOUR_FACULTY_UUID_1', 'Dr. Rajesh Kumar', 'FAC001', 1, 'A', 'faculty', 'active'),
  ('YOUR_FACULTY_UUID_2', 'Dr. Priya Sharma', 'FAC002', 1, 'A', 'faculty', 'active'),
  ('YOUR_STUDENT_UUID_1', 'Rahul Sharma', 'CSIT2021001', 3, 'A', 'student', 'active'),
  ('YOUR_STUDENT_UUID_2', 'Priya Patel', 'CSIT2021002', 3, 'A', 'student', 'active')
ON CONFLICT (id) DO NOTHING;
*/
...
SELECT 'MyCSIT Database Setup Complete!' as status;
